...
import { Binary, ArrowLeft, Trash2, Upload, FileDigit } from 'lucide-react';
        ...
        <div key={i} className="flex hover:bg-slate-800/50 transition-colors border-b border-slate-700/30 last:border-0">
          ...
          <div className="flex-1 flex">
            {rowWords.map((word, idx) => (
              <div key={idx} className="flex-1 p-2 font-mono text-xs md:text-sm text-brand-400 text-center select-all whitespace-nowrap">
